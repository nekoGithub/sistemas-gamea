    ...
    plugins: [
        laravel({
            input: [
                ...
                "resources/js/datatables/datatables-ssls.js",
                "resources/js/datatables/datatables-sistemas.js",
                "resources/js/datatables/datatables-servidores.js",
                "resources/js/datatables/datatables-tecnologias.js",
                "resources/js/datatables/datatables-sistemas-operativos.js",
                "resources/js/datatables/datatables-bases-datos.js",
                "resources/css/tom-select-ubold.css",
                "resources/js/datatables/datatables-responsables.js",
                "resources/js/datatables/datatables-roles.js",
                "resources/js/datatables/datatables-credenciales.js",
                "resources/js/datatables/datatables-unidades.js",
                "resources/js/components/tom-select.js",
                'resources/js/datatables/datatables-auditorias.js',
                'resources/js/pages/dashboard-gamea.js',
                'resources/js/datatables/datatables-documentos.js',
                'resources/js/datatables/datatables-uploads.js',
                'resources/js/datatables/datatables-notificaciones.js',
            ],
            refresh: true,
        }),
    ],
