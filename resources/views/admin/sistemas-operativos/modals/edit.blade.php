<!-- Modal Editar Sistema Operativo -->
<div class="modal fade" id="editSistemaOperativoModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form id="editSistemaOperativoForm" method="POST" novalidate>
                @csrf
                @method('PUT')

                <input type="hidden" id="editSistemaOperativoId">
