            ...
            <div class="col-md-auto">
                ...
                <div class="card auth-box-form border-0 mb-0">
                    ...
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-auto">
                            <p class="text-muted text-center auth-sub-text mx-auto">Crea tu cuenta completando el formulario
                                a continuación.</p>
                            <x-validation-errors class="mb-4" />
                            <form class="mt-4" method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label" for="name" value="{{ __('Name') }}">Full Name <span
                                            class="text-danger">*</span></label>
                                    <div class="app-search">
                                        <input class="form-control" id="name" placeholder="Geneva Denian"
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="email" value="{{ __('Email') }}">Email address
                                ...
                                <div class="mb-3" data-password="bar">
                                    <label class="form-label" for="password_confirmation"
                                        value="{{ __('Confirm Password') }}">Password <span
                                            class="text-danger">*</span></label>
                                    <div class="app-search">
                                        <input class="form-control" id="password_confirmation" placeholder="••••••••"
                                            type="password" name="password_confirmation" name="password_confirmation"
